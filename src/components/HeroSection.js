			...
			<Slider className="h-full hidden sm:block" {...settings}>
				<div>
					<div className="h-[500px] bg-center bg-no-repeat bg-cover"
					     style={{backgroundImage: 'url(https://cdn.getir.com/getirweb-images/common/hero-posters/getir-mainpage-3.jpg)'}}></div>
				</div>
				<div>
					<div className="h-[500px] bg-center bg-no-repeat bg-cover"
					     style={{backgroundImage: 'url(https://cdn.getir.com/getirweb-images/common/hero-posters/getir-mainpage-2.jpg)'}}></div>
				</div>
				<div>
					<div className="h-[500px] bg-center bg-no-repeat bg-cover"
					     style={{backgroundImage: 'url(https://cdn.getir.com/getirweb-images/common/hero-posters/getir-mainpage-4.jpg)'}}></div>
				</div>
				<div>
					<div className="h-[500px] bg-center bg-no-repeat bg-cover"
					     style={{backgroundImage: 'url(https://cdn.getir.com/getirweb-images/common/hero-posters/getir-mainpage-1.jpg)'}}></div>
				</div>
			</Slider>
